...
<template>
    <Head title="Return Details - MediSaaS" />
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <Link :href="route('purchase-returns.index')" class="flex items-center gap-3 group">
                        ...
                        <h1 class="font-bold text-xl tracking-tight text-slate-800 group-hover:text-emerald-600 transition-colors">Return Details</h1>
                    </Link>
                </div>
            </div>
        </nav>
