...
<template>
    ...
    <StorefrontLayout :company="company" :initial-search-query="filters.q" hide-cart>
        ...
        <div class="flex h-[calc(100vh-73px)] w-full overflow-hidden bg-slate-50 -mt-1 shadow-inner select-none">
            
            <!-- ── LEFT SIDEBAR: Categories ── -->
            <aside class="w-56 lg:w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0 overflow-hidden shadow-[4px_0_15px_rgba(0,0,0,0.02)] z-10">
            ...
            <main class="flex-1 flex flex-col overflow-hidden bg-[#f4f7f6] relative">
                ...
                <!-- Center Header -->
                <div class="bg-white border-b border-slate-200 px-5 py-4 flex-shrink-0 z-10 shadow-sm">
            ...
            <!-- ── RIGHT PANEL: Cart ── -->
            <aside class="w-[320px] xl:w-[380px] bg-white border-l border-slate-200 flex flex-col flex-shrink-0 z-20 shadow-[-4px_0_15px_rgba(0,0,0,0.02)]">
