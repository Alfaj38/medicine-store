                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                required 
                                class="w-full bg-[#f0f4f8] border-2 border-transparent text-slate-900 rounded-xl pl-4 pr-12 py-3.5 focus:border-emerald-500 focus:outline-none focus:ring-0 transition-colors font-medium text-sm" 
                                placeholder="••••••••"
                            />
                            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer text-slate-400 hover:text-slate-600 transition-colors focus:outline-none">
